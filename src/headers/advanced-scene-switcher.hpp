...
public slots:
	...
	void on_serverAuthRequired_stateChanged(int state);
	void on_serverPassword_textChanged(const QString &text);
	...
	void on_clientAuthRequired_stateChanged(int state);
	void on_clientPassword_textChanged(const QString &text);
