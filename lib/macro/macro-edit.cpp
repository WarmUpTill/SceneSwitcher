...
MacroEdit::MacroEdit(QWidget *parent) : ui(new Ui_MacroEdit)
{
	ui->setupUi(this);
	ui->macroElseActions->installEventFilter(this);

	ui->conditionsList->SetHelpMsg(
		obs_module_text("MacroEdit.macroTab.editConditionHelp"));
	...
	ui->actionsList->SetHelpMsg(
		obs_module_text("MacroEdit.macroTab.editActionHelp"));
	...
	ui->elseActionsList->SetHelpMsg(
		obs_module_text("MacroEdit.macroTab.editElseActionHelp"));
...
void MacroEdit::SetMacro(const std::shared_ptr<Macro> &macro)
{
	if (_currentMacro) {
		...
		ui->conditionsList->CacheCurrentWidgetsFor(macro.get());
		ui->actionsList->CacheCurrentWidgetsFor(macro.get());
		ui->elseActionsList->CacheCurrentWidgetsFor(macro.get());
	}
...
void MacroEdit::SetElseActionsStateToHidden() const
{
	ui->toggleElseActions->setToolTip(obs_module_text(
		"MacroEdit.macroTab.toggleElseActions.show.tooltip"));
...
{
	ui->toggleElseActions->setToolTip(obs_module_text(
		"MacroEdit.macroTab.toggleElseActions.hide.tooltip"));
	...
	MacroSegmentList *list)
{
	...
	menu.addSeparator();
	menu.addAction(obs_module_text("MacroEdit.macroTab.expandAll"), this,
		       [this, expand]() { expand(this); });
	menu.addAction(obs_module_text("MacroEdit.macroTab.collapseAll"), this,
		       [this, collapse]() { collapse(this); });
	menu.addSeparator();
	menu.addAction(obs_module_text("MacroEdit.macroTab.maximize"), this,
		       [this, maximize]() { maximize(this); });
	menu.addAction(obs_module_text("MacroEdit.macroTab.minimize"), this,
		       [this, minimize]() { minimize(this); });
