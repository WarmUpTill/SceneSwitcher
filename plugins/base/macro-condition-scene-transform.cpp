...
const static std::map<MacroConditionSceneTransform::SettingsType, std::string>
	settingsTypes = {
...
const static std::map<MacroConditionSceneTransform::Compare, std::string>
	compareTypes = {
...
const static std::map<MacroConditionSceneTransform::Condition, std::string>
	conditionTypes = {
...
{
	populateTypesSelection(_settingsType, settingsTypes);
	populateTypesSelection(_compare, compareTypes);
	populateTypesSelection(_conditions, conditionTypes);
