...
static const int COL_MACRO = 1;
static const int COL_SCHEDULE = 2;
static const int COL_NEXT_TRIGGER = 3;
static const int COL_STATUS = 4;
...
void MacroScheduleTab::AddAtTime(const QDateTime &startTime)
{
	...
	if (_addBttonHighlight) {
		_addBttonHighlight->deleteLater();
		_addBttonHighlight = nullptr;
	}
}
